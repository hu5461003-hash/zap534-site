      ...
      const renderItem = (item, index) => {
         ...
         let bHtml = String(item.b || '');
         bHtml = bHtml.replace(/__z(\d+)__/g, function (m, id) { return (window.Z_EMOJI && window.Z_EMOJI[id]) || m; });
         bHtml = bHtml.replace(/<img /g, '<img loading="lazy" ');
